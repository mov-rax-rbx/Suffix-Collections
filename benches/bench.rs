...
fn my_suffix_tree_to_suffix_array_build_usize(c: &mut Criterion) {
    let tree = SuffixTree::new(LINE);
    c.bench_function("SuffixArray::<usize>::from(suffix_tree)", |b| {
        b.iter(|| {
            let _ = SuffixArray::<usize>::from(tree.clone());
        })
    });
}

fn my_suffix_tree_to_suffix_array_build_u32(c: &mut Criterion) {
    let tree = SuffixTree::new(LINE);
    c.bench_function("SuffixArray::<u32>::from(suffix_tree)", |b| {
        b.iter(|| {
            let _ = SuffixArray::<u32>::from(tree.clone());
        })
    });
}

fn my_suffix_tree_to_lcp_usize(c: &mut Criterion) {
    let tree = SuffixTree::new(LINE);
    c.bench_function("suffix_tree.lcp::<usize>()", |b| {
        b.iter(|| {
            let _ = tree.lcp::<usize>();
        })
    });
}

fn my_suffix_tree_to_lcp_u32(c: &mut Criterion) {
    let tree = SuffixTree::new(LINE);
    c.bench_function("suffix_tree.lcp::<u32>()", |b| {
        b.iter(|| {
            let _ = tree.lcp::<u32>();
        })
    });
...
fn my_suffix_tree_build_ukkonen_online(c: &mut Criterion) {
    c.bench_function("Suffix tree build Ukkonen online", |b| {
        b.iter(|| {
...
criterion_group!(
    ...
    my_suffix_tree_build_ukkonen_online,
    my_suffix_tree_find,
    my_suffix_tree_to_suffix_array_build_usize,
    my_suffix_tree_to_suffix_array_build_u32,
    my_suffix_tree_to_lcp_usize,
    my_suffix_tree_to_lcp_u32,
);
